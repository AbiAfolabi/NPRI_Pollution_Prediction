...
def main():
    ...
    with open('/home/abi_norquest_ml/NPRI_Project_Lab2/model/random_forest_model.pkl', 'rb') as f:
        model = pickle.load(f)

    # Load the feature-engineered dataset
    data_path = "/home/abi_norquest_ml/NPRI_Project_Lab2/data/processed/combined_data.csv"
